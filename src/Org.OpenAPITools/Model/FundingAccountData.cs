...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FundingAccountData : IValidatableObject
    {
        ...
        /// <param name="source">(**Required as minimum for Tokenization**) The source of the account. Must be one of   * ACCOUNT_ON_FILE   * ACCOUNT_ADDED_MANUALLY   * ACCOUNT_ADDED_VIA_APPLICATION   * EXISTING_TOKEN_CREDENTIAL&lt;br&gt;     - **NOTE** :Only applicable for certain cross-program enrollment use-cases of [Mastercard Checkout Solutions](https://developer.mastercard.com/mastercard-checkout-solutions/documentation/use-cases/card-on-file/). Please refer to relevant documentation for more info. .</param>
        ...
        /// <summary>
        /// (**Required as minimum for Tokenization**) The source of the account. Must be one of   * ACCOUNT_ON_FILE   * ACCOUNT_ADDED_MANUALLY   * ACCOUNT_ADDED_VIA_APPLICATION   * EXISTING_TOKEN_CREDENTIAL&lt;br&gt;     - **NOTE** :Only applicable for certain cross-program enrollment use-cases of [Mastercard Checkout Solutions](https://developer.mastercard.com/mastercard-checkout-solutions/documentation/use-cases/card-on-file/). Please refer to relevant documentation for more info. 
        /// </summary>
        /// <value>(**Required as minimum for Tokenization**) The source of the account. Must be one of   * ACCOUNT_ON_FILE   * ACCOUNT_ADDED_MANUALLY   * ACCOUNT_ADDED_VIA_APPLICATION   * EXISTING_TOKEN_CREDENTIAL&lt;br&gt;     - **NOTE** :Only applicable for certain cross-program enrollment use-cases of [Mastercard Checkout Solutions](https://developer.mastercard.com/mastercard-checkout-solutions/documentation/use-cases/card-on-file/). Please refer to relevant documentation for more info. </value>
