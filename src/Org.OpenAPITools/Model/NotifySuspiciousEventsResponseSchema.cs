...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotifySuspiciousEventsResponseSchema")]
    public partial class NotifySuspiciousEventsResponseSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifySuspiciousEventsResponseSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotifySuspiciousEventsResponseSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifySuspiciousEventsResponseSchema" /> class.
        /// </summary>
        /// <param name="responseId">The Id of the response returned. (required).</param>
        public NotifySuspiciousEventsResponseSchema(string responseId = default(string))
        {
            // to ensure "responseId" is required (not null)
            if (responseId == null)
            {
                throw new ArgumentNullException("responseId is a required property for NotifySuspiciousEventsResponseSchema and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotifySuspiciousEventsResponseSchema {\n");
