...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotifyServiceActivatedResponseSchema")]
    public partial class NotifyServiceActivatedResponseSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifyServiceActivatedResponseSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotifyServiceActivatedResponseSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifyServiceActivatedResponseSchema" /> class.
        /// </summary>
        /// <param name="responseId">The Id of the response returned. (required).</param>
        public NotifyServiceActivatedResponseSchema(string responseId = default(string))
        {
            // to ensure "responseId" is required (not null)
            if (responseId == null)
            {
                throw new ArgumentNullException("responseId is a required property for NotifyServiceActivatedResponseSchema and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotifyServiceActivatedResponseSchema {\n");
