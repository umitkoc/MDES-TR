...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tokenDataSchemaforNTU")]
    public partial class TokenDataSchemaforNTU : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataSchemaforNTU" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenDataSchemaforNTU() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataSchemaforNTU" /> class.
        /// </summary>
        ...
        public TokenDataSchemaforNTU(string token = default(string), string expiryMonth = default(string), string expiryYear = default(string))
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for TokenDataSchemaforNTU and cannot be null");
            }
            this.token = token;
            // to ensure "expiryMonth" is required (not null)
            if (expiryMonth == null)
            {
                throw new ArgumentNullException("expiryMonth is a required property for TokenDataSchemaforNTU and cannot be null");
            }
            this.expiryMonth = expiryMonth;
            // to ensure "expiryYear" is required (not null)
            if (expiryYear == null)
            {
                throw new ArgumentNullException("expiryYear is a required property for TokenDataSchemaforNTU and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenDataSchemaforNTU {\n");
