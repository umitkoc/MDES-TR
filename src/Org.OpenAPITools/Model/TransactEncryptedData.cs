...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TransactEncryptedData : IValidatableObject
    {
        ...
        /// <example>11223344556677889900112233445566</example>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Track2Equivalent (string) minLength
            if (this.Track2Equivalent != null && this.Track2Equivalent.Length < 32)
            {
                yield return new ValidationResult("Invalid value for Track2Equivalent, length must be greater than 32.", new [] { "Track2Equivalent" });
            }
            ...
            // De48se43Data (string) minLength
            if (this.De48se43Data != null && this.De48se43Data.Length < 1)
            {
                yield return new ValidationResult("Invalid value for De48se43Data, length must be greater than 1.", new [] { "De48se43Data" });
            }
