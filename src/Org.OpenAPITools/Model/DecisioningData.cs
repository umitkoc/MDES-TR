...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DecisioningData : IValidatableObject
    {
        ...
        /// <example>94e09c05c05aa8d183d14aeac628ebb7c0325e80881811f2ac53e81db86eb0b6</example>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Recommendation (string) minLength
            if (this.Recommendation != null && this.Recommendation.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Recommendation, length must be greater than 1.", new [] { "Recommendation" });
            }
            ...
            // RecommendationAlgorithmVersion (string) minLength
            if (this.RecommendationAlgorithmVersion != null && this.RecommendationAlgorithmVersion.Length < 1)
            {
                yield return new ValidationResult("Invalid value for RecommendationAlgorithmVersion, length must be greater than 1.", new [] { "RecommendationAlgorithmVersion" });
            }

            // DeviceScore (string) maxLength
            if (this.DeviceScore != null && this.DeviceScore.Length > 1)
            {
                yield return new ValidationResult("Invalid value for DeviceScore, length must be less than 1.", new [] { "DeviceScore" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AccountScore, length must be less than 1.", new [] { "AccountScore" });
            }
            ...
            // DeviceCurrentLocation (string) minLength
            if (this.DeviceCurrentLocation != null && this.DeviceCurrentLocation.Length < 1)
            {
                yield return new ValidationResult("Invalid value for DeviceCurrentLocation, length must be greater than 1.", new [] { "DeviceCurrentLocation" });
            }
            ...
            // DeviceIpAddress (string) minLength
            if (this.DeviceIpAddress != null && this.DeviceIpAddress.Length < 7)
            {
                yield return new ValidationResult("Invalid value for DeviceIpAddress, length must be greater than 7.", new [] { "DeviceIpAddress" });
            }
