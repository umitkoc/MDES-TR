...
namespace Org.OpenAPITools.Model
{
    ...
    /// Suspend
    /// </summary>
    [DataContract(Name = "Suspend")]
    public partial class Suspend : IValidatableObject
    {
        /// <summary>
        ...
        public Suspend(string responseHost = default(string), string requestId = default(string), string paymentAppInstanceId = default(string), List<string> tokenUniqueReferences = default(List<string>), string causedBy = default(string), string reason = default(string), string reasonCode = default(string))
        {
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for Suspend and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "tokenUniqueReferences" is required (not null)
            if (tokenUniqueReferences == null)
            {
                throw new ArgumentNullException("tokenUniqueReferences is a required property for Suspend and cannot be null");
            }
            this.TokenUniqueReferences = tokenUniqueReferences;
            // to ensure "causedBy" is required (not null)
            if (causedBy == null)
            {
                throw new ArgumentNullException("causedBy is a required property for Suspend and cannot be null");
            }
            this.CausedBy = causedBy;
            // to ensure "reasonCode" is required (not null)
            if (reasonCode == null)
            {
                throw new ArgumentNullException("reasonCode is a required property for Suspend and cannot be null");
            }
