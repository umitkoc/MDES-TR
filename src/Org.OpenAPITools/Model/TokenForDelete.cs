...
namespace Org.OpenAPITools.Model
{
    ...
    /// TokenForDelete
    /// </summary>
    [DataContract(Name = "token_for_delete")]
    public partial class TokenForDelete : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenForDelete" /> class.
        /// </summary>
        ...
        /// <param name="status">The current status of Token. Must be   * &#39;DEACTIVATED&#39; (Token has been permanently deactivated). .</param>
        ...
        public TokenForDelete(string tokenUniqueReference = default(string), string status = default(string), string statusTimestamp = default(string))
        {
        ...
        /// <summary>
        /// The current status of Token. Must be   * &#39;DEACTIVATED&#39; (Token has been permanently deactivated). 
        /// </summary>
        /// <value>The current status of Token. Must be   * &#39;DEACTIVATED&#39; (Token has been permanently deactivated). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenForDelete {\n");
