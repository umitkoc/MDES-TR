...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeliverActivationCodeResponseSchema")]
    public partial class DeliverActivationCodeResponseSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliverActivationCodeResponseSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeliverActivationCodeResponseSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliverActivationCodeResponseSchema" /> class.
        /// </summary>
        /// <param name="responseId">The id of the response returned. (required).</param>
        public DeliverActivationCodeResponseSchema(string responseId = default(string))
        {
            // to ensure "responseId" is required (not null)
            if (responseId == null)
            {
                throw new ArgumentNullException("responseId is a required property for DeliverActivationCodeResponseSchema and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeliverActivationCodeResponseSchema {\n");
