...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTaskStatusResults")]
    public partial class GetTaskStatusResults : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTaskStatusResults" /> class.
        /// </summary>
        ...
        public GetTaskStatusResults(string responseId = default(string), string responseHost = default(string), string status = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTaskStatusResults {\n");
