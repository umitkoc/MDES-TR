...
namespace Org.OpenAPITools.Model
{
    ...
    /// DeleteResults
    /// </summary>
    [DataContract(Name = "DeleteResults")]
    public partial class DeleteResults : IValidatableObject
    {
        /// <summary>
        ...
        public DeleteResults(string responseHost = default(string), string responseId = default(string), List<TokenForDelete> tokens = default(List<TokenForDelete>))
        {
        ...
        public List<TokenForDelete> Tokens { get; set; }
