...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tokenDataSchema1")]
    public partial class TokenDataSchema1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataSchema1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenDataSchema1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDataSchema1" /> class.
        /// </summary>
        ...
        public TokenDataSchema1(string token = default(string), string expiryMonth = default(string), string expiryYear = default(string), string sequenceNumber = default(string))
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for TokenDataSchema1 and cannot be null");
            }
            this.token = token;
            // to ensure "expiryMonth" is required (not null)
            if (expiryMonth == null)
            {
                throw new ArgumentNullException("expiryMonth is a required property for TokenDataSchema1 and cannot be null");
            }
            this.expiryMonth = expiryMonth;
            // to ensure "expiryYear" is required (not null)
            if (expiryYear == null)
            {
                throw new ArgumentNullException("expiryYear is a required property for TokenDataSchema1 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenDataSchema1 {\n");
