...
namespace Org.OpenAPITools.Model
{
    ...
    /// SearchTokensResults
    /// </summary>
    [DataContract(Name = "SearchTokensResults")]
    public partial class SearchTokensResults : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchTokensResults" /> class.
        /// </summary>
        ...
        public SearchTokensResults(string responseHost = default(string), string responseId = default(string), List<Token> tokens = default(List<Token>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchTokensResults {\n");
