...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "fundingAccountInfoSchema1")]
    public partial class FundingAccountInfoSchema1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingAccountInfoSchema1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FundingAccountInfoSchema1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingAccountInfoSchema1" /> class.
        /// </summary>
        /// <param name="tokenUniqueReference">A unique reference assigned following the allocation of a token used to identify the token for the duration of its lifetime. Note - It is required to be always present, even when an error occurs..</param>
        ...
        public FundingAccountInfoSchema1(string tokenUniqueReference = default(string), string panUniqueReference = default(string), EncryptedPayloadIn encryptedPayload = default(EncryptedPayloadIn))
        {
            // to ensure "encryptedPayload" is required (not null)
            if (encryptedPayload == null)
            {
                throw new ArgumentNullException("encryptedPayload is a required property for FundingAccountInfoSchema1 and cannot be null");
            }
        ...
        /// <summary>
        /// A unique reference assigned following the allocation of a token used to identify the token for the duration of its lifetime. Note - It is required to be always present, even when an error occurs.
        /// </summary>
        /// <value>A unique reference assigned following the allocation of a token used to identify the token for the duration of its lifetime. Note - It is required to be always present, even when an error occurs.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FundingAccountInfoSchema1 {\n");
