...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MediaContent : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Height (string) minLength
            if (this.Height != null && this.Height.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Height, length must be greater than 1.", new [] { "Height" });
            }
            ...
            // Width (string) minLength
            if (this.Width != null && this.Width.Length < 1)
            {
                yield return new ValidationResult("Invalid value for Width, length must be greater than 1.", new [] { "Width" });
            }
