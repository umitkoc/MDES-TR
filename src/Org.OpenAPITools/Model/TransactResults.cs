...
namespace Org.OpenAPITools.Model
{
    ...
    /// TransactResults
    /// </summary>
    [DataContract(Name = "TransactResults")]
    public partial class TransactResults : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactResults" /> class.
        /// </summary>
        ...
        public TransactResults(string responseId = default(string), string responseHost = default(string), EncryptedPayloadTransact encryptedPayload = default(EncryptedPayloadTransact))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactResults {\n");
