...
namespace Org.OpenAPITools.Model
{
    ...
    /// NotifyTokenUpdated
    /// </summary>
    [DataContract(Name = "NotifyTokenUpdated")]
    public partial class NotifyTokenUpdated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifyTokenUpdated" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotifyTokenUpdated() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifyTokenUpdated" /> class.
        /// </summary>
        ...
        /// <param name="redigitizationRequired">Flag to indicate that the tokens need to be re-digitized because they are about to expire. This applies to all tokens in the Tokens array. **NOT APPLICABLE FOR SERVER BASED TOKENS** .</param>
        public NotifyTokenUpdated(string responseHost = default(string), string requestId = default(string), EncryptedPayload encryptedPayload = default(EncryptedPayload), bool redigitizationRequired = default(bool))
        {
            // to ensure "responseHost" is required (not null)
            if (responseHost == null)
            {
                throw new ArgumentNullException("responseHost is a required property for NotifyTokenUpdated and cannot be null");
            }
            this.ResponseHost = responseHost;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for NotifyTokenUpdated and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "encryptedPayload" is required (not null)
            if (encryptedPayload == null)
            {
                throw new ArgumentNullException("encryptedPayload is a required property for NotifyTokenUpdated and cannot be null");
            }
            this.EncryptedPayload = encryptedPayload;
            this.RedigitizationRequired = redigitizationRequired;
        }
        ...
        /// <summary>
        /// Flag to indicate that the tokens need to be re-digitized because they are about to expire. This applies to all tokens in the Tokens array. **NOT APPLICABLE FOR SERVER BASED TOKENS** 
        /// </summary>
        /// <value>Flag to indicate that the tokens need to be re-digitized because they are about to expire. This applies to all tokens in the Tokens array. **NOT APPLICABLE FOR SERVER BASED TOKENS** </value>
        /// <example>false</example>
        [DataMember(Name = "redigitizationRequired", EmitDefaultValue = true)]
        public bool RedigitizationRequired { get; set; }
