...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EncryptedPayloadOut1")]
    public partial class EncryptedPayloadOut1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncryptedPayloadOut1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EncryptedPayloadOut1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EncryptedPayloadOut1" /> class.
        /// </summary>
        /// <param name="publicKeyFingerprint">The fingerprint of the public key used to encrypt the ephemeral AES key. Type - String Hex-encoded Data (case-insensitive). Required - Yes. (required).</param>
        /// <param name="encryptedKey">One-time use AES key encrypted by the Mastercard public key (as identified by &#39;publicKeyFingerprint&#39;) using the OAEP or RSA Encryption Standard PKCS 1 v1.5 (depending on the value of &#39;oaepHashingAlgorithm&#39;). Requirement is for a 128-bit key (with 256-bit key supported as an option). Data Type - String. Hex-encoded data (case-insensitive). Max Length - 512. Required - Yes. (required).</param>
        ...
        public EncryptedPayloadOut1(string publicKeyFingerprint = default(string), string encryptedKey = default(string), string oaepHashingAlgorithm = default(string), string iv = default(string), AccountInformationDataSchema encryptedData = default(AccountInformationDataSchema))
        {
            // to ensure "publicKeyFingerprint" is required (not null)
            if (publicKeyFingerprint == null)
            {
                throw new ArgumentNullException("publicKeyFingerprint is a required property for EncryptedPayloadOut1 and cannot be null");
            }
            this.publicKeyFingerprint = publicKeyFingerprint;
            // to ensure "encryptedKey" is required (not null)
            if (encryptedKey == null)
            {
                throw new ArgumentNullException("encryptedKey is a required property for EncryptedPayloadOut1 and cannot be null");
            }
            this.encryptedKey = encryptedKey;
            // to ensure "encryptedData" is required (not null)
            if (encryptedData == null)
            {
                throw new ArgumentNullException("encryptedData is a required property for EncryptedPayloadOut1 and cannot be null");
            }
        ...
        /// <summary>
        /// The fingerprint of the public key used to encrypt the ephemeral AES key. Type - String Hex-encoded Data (case-insensitive). Required - Yes.
        /// </summary>
        /// <value>The fingerprint of the public key used to encrypt the ephemeral AES key. Type - String Hex-encoded Data (case-insensitive). Required - Yes.</value>
        ...
        /// </summary>
        /// <value>One-time use AES key encrypted by the Mastercard public key (as identified by &#39;publicKeyFingerprint&#39;) using the OAEP or RSA Encryption Standard PKCS 1 v1.5 (depending on the value of &#39;oaepHashingAlgorithm&#39;). Requirement is for a 128-bit key (with 256-bit key supported as an option). Data Type - String. Hex-encoded data (case-insensitive). Max Length - 512. Required - Yes.</value>
        ...
        public AccountInformationDataSchema encryptedData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncryptedPayloadOut1 {\n");
