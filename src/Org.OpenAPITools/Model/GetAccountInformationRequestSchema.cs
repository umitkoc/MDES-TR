...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAccountInformationRequestSchema")]
    public partial class GetAccountInformationRequestSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAccountInformationRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAccountInformationRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAccountInformationRequestSchema" /> class.
        /// </summary>
        ...
        public GetAccountInformationRequestSchema(string requestId = default(string), FundingAccountInfoSchema1 fundingAccountInfo = default(FundingAccountInfoSchema1))
        {
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAccountInformationRequestSchema and cannot be null");
            }
            this.requestId = requestId;
            // to ensure "fundingAccountInfo" is required (not null)
            if (fundingAccountInfo == null)
            {
                throw new ArgumentNullException("fundingAccountInfo is a required property for GetAccountInformationRequestSchema and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAccountInformationRequestSchema {\n");
