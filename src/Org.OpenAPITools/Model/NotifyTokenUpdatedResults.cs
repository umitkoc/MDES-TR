...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotifyTokenUpdatedResults")]
    public partial class NotifyTokenUpdatedResults : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotifyTokenUpdatedResults" /> class.
        /// </summary>
        ...
        public NotifyTokenUpdatedResults(string responseHost = default(string), string responseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotifyTokenUpdatedResults {\n");
