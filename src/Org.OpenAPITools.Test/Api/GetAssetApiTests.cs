...
{
    /// <summary>
    ///  Class for testing GetAssetApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class GetAssetApiTests : IDisposable
    {
        private GetAssetApi instance;

        public GetAssetApiTests()
        {
            instance = new GetAssetApi();
        }
        ...
        /// <summary>
        /// Test an instance of GetAssetApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' GetAssetApi
            //Assert.IsType<GetAssetApi>(instance);
        }
        ...
        public void GetAssetTest()
        {
            ...
            //Assert.IsType<AssetResults>(response);
        }
    }
}
