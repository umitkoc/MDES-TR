...
namespace Org.OpenAPITools.Test.Api
{
    ...
    /// </remarks>
    public class DeleteApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' DeleteApi
            //Assert.IsType<DeleteApi>(instance);
        }

        /// <summary>
        /// Test DeleteDigitization
        /// </summary>
        [Fact]
        public void DeleteDigitizationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Delete delete = null;
            //var response = instance.DeleteDigitization(delete);
            //Assert.IsType<DeleteResults>(response);
        }
    }
}
